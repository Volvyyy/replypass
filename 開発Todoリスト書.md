...
1. **BE-002: ヘルスチェックエンドポイント** - 基本API機能、サーバー稼働確認
2. **BE-004: Userモデル・リポジトリ** - データアクセス層基盤（SQLAlchemy）
3. **BE-005: Caseモデル・リポジトリ** - ケース管理データ層
4. **API-003: ケース一覧取得API** - ユーザー登録後の基本機能  
5. **FE-004: ダッシュボード画面実装** - 認証後のメイン画面
