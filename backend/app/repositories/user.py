...
class UserRepository(BaseRepository[User]):
    ...
    async def create(
        self, email: str, auth_id: str, profile: Optional[Dict[str, Any]] = None
    ) -> User:
        """
        Create a new user
        ...
        return await super().create(email=email, auth_id=auth_id, profile=profile)
    ...
    async def search_by_display_name(self, query: str, limit: int = 10) -> list[User]:
        """
